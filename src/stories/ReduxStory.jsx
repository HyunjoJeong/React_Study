...
storiesOf('ReduxApp', module)
  .addWithJSX('01_기본 스토어 설정', () => <ReduxApp01 />)
  .addWithJSX('02_Dispatch', () => <ReduxApp02 />)
  .addWithJSX('03_기본 리듀서', () => <ReduxApp03 />)
  .addWithJSX('다중 리듀서 설정', () => <AdvReduxApp01 />) // 얘는 정상작동 안할 것. 작동시킬라면 07/reducers/index.js 에서 import를 버전2로 둘 다 바꿔보삼
